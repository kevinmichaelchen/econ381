...
In more concrete results, we find that adult mortality per hundred thousand is higher in FC states, though the actual mechanism for this change is somewhat unclear.  Both chronic and non-chronic mortality are statistically more prevalent in FC reservations, but several important causes of death in Native American communities, like cancer and heart disease, did not feature a statistically significant change when comparing FC reservations to other Native American communities.
